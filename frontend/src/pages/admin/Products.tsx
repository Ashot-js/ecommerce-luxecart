...
const MOCK_PRODUCTS: Product[] = [
  ...
  { id: '7', name: 'LED Floor Lamp', slug: 'led-floor-lamp', description: '', price: 119.99, compare_price: null, stock: 3, category_id: null, category_name: 'Home & Garden', image_url: null, images: [], featured: false, active: true, rating: 4.8, review_count: 53, created_at: '', updated_at: '' },
